...
export default function App() {
  ...
  const calcGroupedOrder = () =>
    tableStore.getSortedRowIds("task", "idTag", false);
  ...
  const handleKeydown = (event) => {
    ...
    if (targetTaskId > -1) {
      const targetTaskPriority = tableStore.getCell(
        "task",
        targetTaskId,
        "priority",
        tableStore
  ...
  const calcNewOrder = () =>
    tableStore.getSortedRowIds("task", "priority", true);
